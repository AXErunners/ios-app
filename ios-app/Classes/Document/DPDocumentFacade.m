...
@property (nullable, weak, nonatomic) AxePlatformProtocol *app;
...
- (instancetype)initWithAPP:(AxePlatformProtocol *)app
...
- (nullable DPDocumentFactory *)factory {
    NSString *userId = self.app.userId;
    NSParameterAssert(userId);
    if (!userId) {
        return nil;
    }
    DPContract *contract = self.app.contract;
